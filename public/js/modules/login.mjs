...
const logUser = (mailInpt, paswrdInpt) => {
    ...
    FIREBASE.authFuncs
        .signInWithEmailAndPassword(FIREBASE.FBAUTH, mailInpt.value, paswrdInpt.value)
        ...
        .catch((err) => {
            ...
            switch (errCode) {
                ...
                case "auth/internal-error":
                    global.frmLoginMsg.textContent =
                        "El servidor de autenticacion encontro un error inesperado al procesar la solicitud. Intenta mas tarde";
                    break;
                default:
